                ...
                <div class="row">
                    @forelse(config('defaults.imports') as $key => $import)
                        <div class="col-lg-3 col-lg-3">
                            <div class="upload">
                                <form class="panel" method="POST" action="{{route('import-data.store')}}" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                    <div class="upload-files">
                                        ...
                                        <footer>
                                            ...
                                            <button type="submit" class="save-file btn-{{$import}}">SAVE FILE</button>
                                        </footer>
                                    </div>
                                </form>
                            </div>  
