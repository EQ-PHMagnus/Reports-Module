    ...
    'menu' => [
        'bets' => [
            'total-count-bets'    =>  [
                ...
                'type'                  =>  'count',
                'url'                   =>  config('app.url').('raven/bets/total-count-bets')
            ],
            'total-amount-bets'    =>  [
                'title'                 =>  'Total Bets Amount ',
                'content_title'         =>  'Total Amount of Bets',
                'type'                  =>  'sum',
                'url'                   =>  config('app.url').('raven/bets/total-amount-bets')
            ],
            'total-count-bets-arena'    =>  [
                ...
                'type'                  =>  'sum',
                'name'                  =>  'arena',
                'url'                   =>  config('app.url').('raven/bets/total-count-bets-arena')
            ],
            'total-amount-bets-arena'    =>  [
                ...
                'type'                  =>  'sum',
                'name'                  =>  'arena',
                'url'                       =>  config('app.url').('raven/bets/total-amount-bets-arena')
            ],
        ],
        ...
        'fights' => [
                'total-count-fights'    =>  [
                    ...
                    'type'                  =>  'count',
                    'url'                       =>  config('app.url').('raven/fights/total-count-fights')
                ],
                'total-count-fights-arena'    =>  [
                    ...
                    'type'                  =>  'count',
                    'name'                  =>  'arena',
                    'url'                       =>  config('app.url').('raven/fights/total-count-fights-arena')
                ],
        ...
        'agent-deposits' => [
            'pending'    =>  [
                ...
                'type'                  =>  'pending',
                'url'                       =>  config('app.url').('raven/agent-deposits/pending')
            ],
            'processed'    =>  [
                'title'                 =>  'Agent Deposits Processed',
                'content_title'         =>  'Processed List',
                'type'                  =>  'processed',
                'url'                       =>  config('app.url').('raven/agent-deposits/processed')
            ],
